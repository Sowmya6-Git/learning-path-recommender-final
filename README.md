...
* To reduce learning overload for beginners

* To assess basic knowledge before suggesting advanced topics

* To provide a simple and structured learning plan
...
* Beginner-level learning plans based on duration
...
2. The user chooses their experience level:
...
3. Based on the selection:
    ...
    Beginners choose the number of days and receive a day-wise plan

    Users with basic knowledge take a short assessment
...
* Good performance leads to advanced topics

* Average performance leads to a mixed roadmap

* Poor performance redirects to foundational topics
